...
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (1, 'Riu Ebre', 'Campredó', 'Tortosa', 'Amposta');
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (2, 'Riu Ebre', 'Tortosa', 'Xerta', 'Campredó');
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (3, 'Riu Ebre', 'Amposta', 'Campredó', 'Sant Jaume');
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (1, 'Pantà de Siurana', 'Campredó', 'Tortosa', 'Amposta');
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (2, 'Pantà de Siurana', 'Tortosa', 'Xerta', 'Campredó');
insert into zones(num_zona, nom_massa, municipi, limit_superior, limit_inferior) values (1, 'Mar Mediterrani', 'La Cava', 'Sant Carles de la Ràpita', 'La Ampolla');
